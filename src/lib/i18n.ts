...
export const languageCopy = {
  en: {
    auth: {
      ...
      login: "Log in",
      loginToContinue: "Log in to Pulse to continue.",
    ...
    home: {
      ...
      mainHeadline: "Built for real life",
      mainDescription: "An app that actually keeps up with you",
      getStarted: "Register",
      explore: "Login",
    },
    modules: {
  ...
  sr: {
    auth: {
      ...
      login: "Prijava",
      loginToContinue: "Prijavite se da nastavite u Pulse.",
    ...
    home: {
      ...
      mainHeadline: "Napravljen za pravi život",
      mainDescription: "Aplikacija koja zaista ide u korak s tobom",
