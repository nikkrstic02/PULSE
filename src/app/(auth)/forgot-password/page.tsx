...
export default function ForgotPasswordPage() {
  ...
  return (
    <main className="ken-auth-shell flex items-center justify-center p-6">
      <div className="ken-glass w-full max-w-[520px] rounded-[18px] px-8 py-9 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
        <div className="flex flex-col items-center">
          <div className="ken-wordmark text-2xl">KEN</div>
          <div className="mt-4 text-3xl font-semibold text-white">{authCopy.changePassword}</div>
