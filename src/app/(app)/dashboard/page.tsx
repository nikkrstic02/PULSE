    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="text-4xl font-black tracking-tight">{dashboardCopy.welcomeBack}</h1>
          <p className="mt-3 text-sm text-slate-300">{dashboardCopy.signedInAs} {user?.email}</p>
